...
namespace myApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //     bankAccount accountname = (bankAccount) Console.ReadLine();
            ...
            //     bankAccount yourname = (bankAccount) Console.ReadLine();
            ...
            // } //running into issues here due to what I tell get details. see line 32-36
             ...
             System.Console.WriteLine("Please enter the name of the account to open");
                ...
                System.Console.WriteLine("Do you want to enter money into the account?");
                int amountof = int.Parse(Console.ReadLine());
                List<int> accountnumbers = new List<int>{account};
                bankAccount accountname = new bankAccount(name, accountnumbers, amountof);
                Methods.bankAccountAdd(name, accountname);
                List<bankAccount> accountofperson = Methods.bankAccountRetrieve(name);
                bankAccount.GetDetails(accountofperson);            
